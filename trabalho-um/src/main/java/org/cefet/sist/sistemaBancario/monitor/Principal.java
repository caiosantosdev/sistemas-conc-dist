...
public class Principal {
    public static void main(String[] args) throws InterruptedException {
        ...
        OperacaoSaque op2 = new OperacaoSaque(banco, maeDoJoel.getId(), 50.0);
        OperacaoSaque op3 = new OperacaoSaque(banco, esposaDoJoel.getId(), 50.0);
        OperacaoSaque op4 = new OperacaoSaque(banco, tiaJoel.getId(), 50.0);
